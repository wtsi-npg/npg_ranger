...
describe('server fetching', function() {
  ...
  let options = config.provide(() => {return {debug: true, mongourl: mongourl};});
  let expectedMd5s = {
    'single file': {
      'SAM' : '16b3d79daec1da26d98a4e1b63e800b0',
      'BAM' : '16b3d79daec1da26d98a4e1b63e800b0',
      'CRAM': '16b3d79daec1da26d98a4e1b63e800b0',
      'VCF' : '240fc20131e144d440e7c488310f5f08'
    },
    'multiple (merged) files': {
      'SAM' : '79cb05e3fe428da52da346e7d4f6324a',
      'BAM' : '79cb05e3fe428da52da346e7d4f6324a',
      'CRAM': '79cb05e3fe428da52da346e7d4f6324a',
      'VCF' : '240fc20131e144d440e7c488310f5f08'
    }
  };
  let testRuns = {
          ...
          http.get(
            ...
            if (format !== 'VCF') {
              ...
              bamseqchksum.stdout.on('end', function() {
                ...
                expect(hashDigest).toBe(expectedMd5s[description][format]);
                done();
              });
            } else {
              let body = '';
