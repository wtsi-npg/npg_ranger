...
class RangerController {
  ...
  _getData(user, host, query) {
    ...
    dm.once('data', (data) => {
      ...
      // Assumes that all reference files are the same.
      // TODO: Test that this is true.
      LOGGER.debug(data[0].reference);
      query.reference = '/lustre/scratch110/srpipe/references/Homo_sapiens/1000Genomes_hs37d5/all/fasta/hs37d5.fa';
      dm.removeAllListeners();
      if (this.skipAuth) {
