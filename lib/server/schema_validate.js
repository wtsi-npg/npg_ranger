...
/**
* Validate that the POST query passed through is correct.
* First checks if input fits the htsget schema file,
* then checks and merges, if required,
* the region parameter if present.
* @return {object} - the valid (and if suitable, merged) POST query.
* @param {object} POSTQuery - a valid JSON format POST query.
*/
