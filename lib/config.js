...
var provide = function( generateConfigs ) {
  if ( generateConfigs ) {
    ...
    options.set('numworkers', Number.parseInt(options.get('numworkers')));
    options.set('clustermaxdeaths', Number.parseInt(options.get('clustermaxdeaths')));
    options.set('clustertimeout', Number.parseInt(options.get('clustertimeout')));
