...
var fromCommandLine = () => {
  var opt = new GetOpt([
      ...
      ['' ,'unsafe'           ,'disable safe mode. Disables VCF output'],
      ['c','configfile=PATH'  ,'PATH of configfile'],
      ['r','references=PATH'  ,'root PATH for reference files'],
...
var logOpts = function() {
  let optsToLog = ['port', 'mongourl', 'tempdir', 'hostname', 'unsafe', 'configfile', 'skipauth', 'debug'];
